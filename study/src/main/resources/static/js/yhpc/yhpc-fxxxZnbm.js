...
var columns = [
    ...
    , {
        ...
        formatter:function(value,row,index){
            if(value > 0){
                return '<a href="javascript:showFj(\''+row.id+'\');"><span class="badge badge-pill badge-success">'+value+'</span></a>';
            }else{
    ...
    },
    {
        ...
        formatter:function(value,row,index){
            if(value != '') {
                return '<a href="javascript:showYh(\'' + row.id + '\');">点击查看</a>';
...
$(function () {
    ...
    $search.click(function () {
        $table.bootstrapTable('destroy').bootstrapTable({
            url: contextPath + 'yhpc/fxxx/znbm',
            sortName: 'id',
            striped: true,
...
function showFj(fxid){
    layer.open({
        ...
        shadeClose : true,
        area:['45%','30%'],
        content: contextPath+'yhpc/showFj?departId='+departId+'&departName='+departName+'&userId='+userId+'&userName='+userName+'&fxid='+fxid
    });
}


function showYh(fxid){
    layer.open({
        id : 'yhxxAdd',
        type : 2,
        title: '隐患信息查看',
        shadeClose : true,
        area:['45%','55%'],
        content: contextPath+'yhpc/showYh?departId='+departId+'&departName='+departName+'&userId='+userId+'&userName='+userName+'&fxid='+fxid
    });
}
