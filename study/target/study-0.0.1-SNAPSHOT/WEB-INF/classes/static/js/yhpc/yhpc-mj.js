...
var columns = [
    {
        ...
        formatter:function(value,row,index){
            ...
            }else if(row.activitiState == 'isYhxx'){
                operatorBtn = '<button type="button" class="btn btn-outline-primary btn-sm" onclick="javascript:cl(\''+row.activitiState+'\',\''+row.activitiStateName+'\',\''+row.taskId+'\',\''+row.id+'\',\'\',\'\');">录入隐患</button>';
...
$(function () {
    ...
    $search.click(function () {
        $table.bootstrapTable('destroy').bootstrapTable({
            url: contextPath + 'yhpc/fxxx/'+userId,
            sortName: 'id',
            striped: true,
